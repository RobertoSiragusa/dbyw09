...
static struct queue_sysfs_entry queue_mas_wop_abnormal_tst_entry = {
	.attr = {.name = "mas_wop_abnormal_tst", .mode = S_IWUSR },
	.show = NULL,
	.store = mas_queue_wo_abnormal_tst_enable_store,
};

static struct queue_sysfs_entry queue_mas_wop_panic_tst_entry = {
	.attr = {.name = "mas_wop_panic_tst", .mode = S_IWUSR },
	.show = NULL,
	.store = mas_queue_wo_panic_tst_enable_store,
};
#endif
#endif
...
#ifdef CONFIG_MAS_UNISTORE_PRESERVE
	&queue_mas_wop_abnormal_tst_entry.attr,
	&queue_mas_wop_panic_tst_entry.attr,
#endif
#endif
#if defined(CONFIG_MAS_DEBUG_FS) || defined(CONFIG_MAS_BLK_DEBUG)
