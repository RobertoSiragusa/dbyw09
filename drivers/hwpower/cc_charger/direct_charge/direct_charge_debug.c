...
{
	power_dbg_ops_register("sc4_time_para", dev_data,
		dc_dbg_time_para_show, dc_dbg_time_para_store);
	power_dbg_ops_register("sc4_vstep_para", dev_data,
		dc_dbg_vstep_para_show, dc_dbg_vstep_para_store);
	power_dbg_ops_register("sc4_total_ibus", dev_data,
		dc_dbg_total_ibus_show, NULL);
	power_dbg_ops_register("sc4_main_ibus", dev_data,
		dc_dbg_main_ibus_show, NULL);
	power_dbg_ops_register("sc4_main_vbus", dev_data,
		dc_dbg_main_vbus_show, NULL);
	power_dbg_ops_register("sc4_main_vout", dev_data,
		dc_dbg_main_vout_show, NULL);
	power_dbg_ops_register("sc4_main_ibat", dev_data,
		dc_dbg_main_ibat_show, NULL);
	power_dbg_ops_register("sc4_main_vbat", dev_data,
		dc_dbg_main_vbat_show, NULL);
	power_dbg_ops_register("sc4_main_ic_temp", dev_data,
		dc_dbg_main_ic_temp_show, NULL);
	power_dbg_ops_register("sc4_main_ic_id", dev_data,
		dc_dbg_main_ic_id_show, NULL);
	power_dbg_ops_register("sc4_main_ic_name", dev_data,
		dc_dbg_main_ic_name_show, NULL);
	power_dbg_ops_register("sc4_aux_ibus", dev_data,
		dc_dbg_aux_ibus_show, NULL);
	power_dbg_ops_register("sc4_aux_vbus", dev_data,
		dc_dbg_aux_vbus_show, NULL);
	power_dbg_ops_register("sc4_aux_vout", dev_data,
		dc_dbg_aux_vout_show, NULL);
	power_dbg_ops_register("sc4_aux_ibat", dev_data,
		dc_dbg_aux_ibat_show, NULL);
	power_dbg_ops_register("sc4_aux_vbat", dev_data,
		dc_dbg_aux_vbat_show, NULL);
	power_dbg_ops_register("sc4_aux_ic_temp", dev_data,
		dc_dbg_aux_ic_temp_show, NULL);
	power_dbg_ops_register("sc4_aux_ic_id", dev_data,
		dc_dbg_aux_ic_id_show, NULL);
	power_dbg_ops_register("sc4_aux_ic_name", dev_data,
		dc_dbg_aux_ic_name_show, NULL);
	power_dbg_ops_register("sc4_tadapt", dev_data,
		dc_dbg_tadapt_show, NULL);
	power_dbg_ops_register("sc4_vadapt", dev_data,
		dc_dbg_vadapt_show, NULL);
}
