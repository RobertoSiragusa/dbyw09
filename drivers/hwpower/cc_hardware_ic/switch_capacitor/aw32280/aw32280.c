...
{
	if (di->ic_role == CHARGE_IC_TYPE_MAIN) {
		aw32280_lvc_ops.dev_data = di;
		aw32280_sc_ops.dev_data = di;
		aw32280_sc_41_ops.dev_data = di;
		aw32280_batinfo_ops.dev_data = di;
		aw32280_log_ops.dev_data = di;
	} else {
		aw32280_aux_lvc_ops.dev_data = di;
		aw32280_aux_sc_ops.dev_data = di;
		aw32280_aux_sc_41_ops.dev_data = di;
		aw32280_aux_batinfo_ops.dev_data = di;
		aw32280_aux_log_ops.dev_data = di;
	}
}
