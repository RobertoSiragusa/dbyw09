...
static int stm32g031_fcp_master_reset(void *dev_data)
{
	...
	ret = stm32g031_scp_wdt_reset_by_sw(di);
	if (ret)
		return -EPERM;
	...
	return stm32g031_write_byte(di, STM32G031_SCP_CTL_REG, STM32G031_SCP_CTL_REG_INIT);
}
...
static int stm32g031_fcp_adapter_detect(struct stm32g031_device_info *di)
{
	...
	ret = stm32g031_write_mask(di, STM32G031_SCP_CTL_REG, STM32G031_SCP_CTL_EN_SCP_MASK,
		STM32G031_SCP_CTL_EN_SCP_SHIFT, 1);
	ret += stm32g031_write_mask(di, STM32G031_SCP_CTL_REG, STM32G031_SCP_CTL_SCP_DET_EN_MASK,
		STM32G031_SCP_CTL_SCP_DET_EN_SHIFT, 1);
	if (ret) {
...
static struct scp_protocol_ops stm32g031_scp_protocol_ops = {
	.chip_name = "stm32g031",
...
static struct fcp_protocol_ops stm32g031_fcp_protocol_ops = {
	.chip_name = "stm32g031",
...
int stm32g031_scp_protocol_register(struct stm32g031_device_info *di)
{
	stm32g031_scp_protocol_ops.dev_data = (void *)di;
	return scp_protocol_ops_register(&stm32g031_scp_protocol_ops);
}

int stm32g031_fcp_protocol_register(struct stm32g031_device_info *di)
{
	stm32g031_fcp_protocol_ops.dev_data = (void *)di;
	return fcp_protocol_ops_register(&stm32g031_fcp_protocol_ops);
}
