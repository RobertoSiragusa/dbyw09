...
{
	power_dbg_ops_register("app_bat_brand", dev_data,
		power_supply_app_dbg_bat_brand_show, NULL);
	power_dbg_ops_register("app_bat_capacity", dev_data,
		power_supply_app_dbg_bat_capacity_show, NULL);
	power_dbg_ops_register("app_bat_temp", dev_data,
		power_supply_app_dbg_bat_temp_show, NULL);
	power_dbg_ops_register("app_bat_status", dev_data,
		power_supply_app_dbg_bat_status_show, NULL);
	power_dbg_ops_register("app_bat_current_now", dev_data,
		power_supply_app_dbg_bat_current_now_show, NULL);
	power_dbg_ops_register("app_bat_voltage_now", dev_data,
		power_supply_app_dbg_bat_voltage_now_show, NULL);
	power_dbg_ops_register("app_bat_voltage_max", dev_data,
		power_supply_app_dbg_bat_voltage_max_show, NULL);
	power_dbg_ops_register("app_usb_voltage_now", dev_data,
