...
#ifdef CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION
#define HW_ENABLE_CHARGE   		"HW_ENABLE_CHARGE"
#define HW_IIN_THERMAL   		"HW_IIN_THERMAL"
...
#define FLOAT_CURRENT_UA                1200000
#define FCP_CURRENT_UA                  1500000
#define WIRELESS_CURRENT_UA             1200000
#else
...
#define CHANGE_CV_TIMES                 4
#define CHANGE_CV_BATT_CURRENT          1100
#define CHANGE_CUTOFF_CURRENT           (-130)
#define CHANGE_FV_MAX_VOLTAGE           4430000
#define FIFTY_FOR_ITERM_CURRENT         15
#define EIGHT_BIT                       8
#define TWO_BIT                         2
...
struct smb_charger {
	...
	int         input_suspend;
	int         iin_thermal;
	bool        usb_third_bc_12;
	struct      delayed_work bc12_change_work;
	int         ac_online;
	int         usb_online;
	bool        ignore_vbus_irq;
	u8          bypass_vsafe_bit;
	u8          try_sink_bit;
	struct      delayed_work wlrx_sw_work;
#endif /* CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION */
};

#ifdef CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION
void non_pmi_handle_apsd_done(struct smb_charger *chg);
extern int usbswitch_common_chg_type_det(bool en);
#endif /* CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION */
