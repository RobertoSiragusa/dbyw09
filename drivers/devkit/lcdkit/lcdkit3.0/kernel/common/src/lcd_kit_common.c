	...
	struct color_cmds_rgb *color_cmds)
{
	...
	common_info->hbm.circle_color_cmds.cmds[color_cmd_index].
		payload[CMDS_RED_HIGH] = color_cmds->red_payload[0];
	common_info->hbm.circle_color_cmds.cmds[color_cmd_index].
		payload[CMDS_RED_LOW] = color_cmds->red_payload[1];
	common_info->hbm.circle_color_cmds.cmds[color_cmd_index].
		payload[CMDS_GREEN_HIGH] = color_cmds->green_payload[0];
	common_info->hbm.circle_color_cmds.cmds[color_cmd_index].
		payload[CMDS_GREEN_LOW] = color_cmds->green_payload[1];
	common_info->hbm.circle_color_cmds.cmds[color_cmd_index].
		payload[CMDS_BLUE_HIGH] = color_cmds->blue_payload[0];
	common_info->hbm.circle_color_cmds.cmds[color_cmd_index].
		payload[CMDS_BLUE_LOW] = color_cmds->blue_payload[1];
