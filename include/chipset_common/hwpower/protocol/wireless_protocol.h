...
struct wireless_protocol_ops {
	...
	int (*get_tx_capability)(unsigned int ic_type, struct wireless_protocol_tx_cap *cap);
	...
	int (*get_tx_fop_range)(unsigned int ic_type, struct wireless_protocol_tx_fop_range *fop);
