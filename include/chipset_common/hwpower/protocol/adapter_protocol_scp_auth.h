...
#define SCP_AUTH_DIGEST_LEN         16
#define SCP_AUTH_HASH_LEN           (SCP_AUTH_DIGEST_LEN * 2 + 1)
#define SCP_AUTH_WAIT_TIMEOUT       1000
#define SCP_AUTH_GENL_OPS_NUM       1
...
#else
static inline bool scp_auth_get_srv_state(void)
{
	return false;
}

static inline void scp_auth_clean_hash_data(void)
{
}

static inline u8 *scp_auth_get_hash_data_header(void)
{
	return NULL;
}

static inline unsigned int scp_auth_get_hash_data_size(void)
{
	return 0;
}

static inline int scp_auth_wait_completion(void)
{
	return -EPERM;
}
