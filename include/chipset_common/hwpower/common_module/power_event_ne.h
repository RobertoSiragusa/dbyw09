...
enum power_event_notifier_list {
	...
	POWER_NE_WLTX_IRQ_SET_VTX, /* num:65 */
	...
	POWER_NE_CHG_FAULT_SCHARGER, /* num:85 */
	...
	POWER_NE_THIRDPLAT_CHARGING_START, /* num:110 */
	...
	POWER_NE_THIRDPLAT_PD_STOP, /* num:115 */
	/* section: for pd dpm */
